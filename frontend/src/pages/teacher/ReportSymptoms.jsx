...
function ReportSymptoms() {
  ...
  const handleSubmit = (event) => {
    ...
    setTimeout(() => {
      ...
      // Also submit to the isolated doctor-visible reports pipeline
      submitReport({
        senderName: user?.name || "Teacher",
        senderRole: "teacher",
        senderId: user?.id || user?._id || "teacher-default",
        symptoms: selectedSymptoms,
        severity,
        temperature,
        date,
        notes: `[Re: ${student.name}] ${notes}`,
      });
      ...
      setTimeline([
        {
          id: 1,
          date,
          title: "Symptom Observation Submitted",
        ...
        },
        {
          ...
          description: `Health passport for ${student.parent?.name || "parent"} has been updated.`,
          type: "info",
        },
        {
          id: 3,
          ...
          description: "Report sent to doctor's review queue via the medical reporting system.",
          type: "pending",
        },
      ]);
