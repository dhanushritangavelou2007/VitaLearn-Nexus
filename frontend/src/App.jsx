...
import ParentReportSymptoms from "./pages/parent/ReportSymptoms";
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route path="/teacher/notifications" element={<RoleGuard role="teacher"><TeacherNotifications /></RoleGuard>} />
        ...
        <Route path="/parent/notifications"      element={<RoleGuard role="parent"><ParentNotifications /></RoleGuard>} />
        <Route path="/parent/vaccination"        element={<RoleGuard role="parent"><ParentDashboard /></RoleGuard>} />
        <Route path="/parent/report-symptoms"   element={<RoleGuard role="parent"><ParentReportSymptoms /></RoleGuard>} />
        ...
        <Route path="/student/notifications"       element={<RoleGuard role="student"><StudentNotifications /></RoleGuard>} />
