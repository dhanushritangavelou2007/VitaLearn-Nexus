    ...
    <aside className="flex h-screen w-72 flex-col border-r border-slate-200 bg-white/80 backdrop-blur-xl">
      ...
      <div className="border-b border-slate-200 p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-blue-600 to-teal-500 p-3 text-white">
            <HeartPulse size={28} />
          </div>
      ...
      <div className="m-5 rounded-3xl bg-gradient-to-br from-blue-600 to-teal-500 p-5 text-white shadow-xl">
      ...
      <div className="m-5 rounded-3xl bg-slate-100 p-5">
        ...
        <p className="mt-3 text-sm text-slate-500">
          ...
          All summaries require doctor verification.
        </p>
