...
function Sidebar() {
  ...
  const menuMap = {
    ...
    doctor: [
      ...
      { name: "Patients", path: "/doctor/dashboard", icon: Users },
      { name: "Critical Students", path: "/doctor/dashboard", icon: HeartPulse },
      { name: "Appointments", path: "/doctor/dashboard", icon: Activity },
      { name: "Diagnosis", path: "/doctor/dashboard", icon: FileText },
      { name: "Reports", path: "/teacher/reports", icon: FileText },
      { name: "Settings", path: "/settings", icon: Settings },
    ],
    parent: [
      { name: "Dashboard", path: "/parent/dashboard", icon: School },
      { name: "Passport", path: "/parent/dashboard", icon: HeartPulse },
      { name: "Reports", path: "/parent/dashboard", icon: FileText },
      { name: "Timeline", path: "/parent/dashboard", icon: Activity },
      { name: "Notifications", path: "/parent/dashboard", icon: Bell },
      { name: "Settings", path: "/settings", icon: Settings },
    ],
    student: [
      { name: "Dashboard", path: "/student/dashboard", icon: Sparkles },
      { name: "Passport", path: "/student/dashboard", icon: HeartPulse },
      { name: "Reports", path: "/student/dashboard", icon: FileText },
      { name: "Achievements", path: "/student/dashboard", icon: ShieldCheck },
      { name: "Timeline", path: "/student/dashboard", icon: Activity },
      { name: "Vaccination", path: "/student/dashboard", icon: HeartPulse },
      { name: "Settings", path: "/settings", icon: Settings },
    ],
    admin: [
